...
\abstract[en]{
Aim of this paper is design and implementation of tools which allow to display testing progress of Eclipse integrated development environment instance. This resolves problem of viewing currently running graphical user interface test run results. This thesis also contains description of Eclipse IDE (\emph{Integrated Development Environment}) and JUnit framework architecture, that is used to achieve this goal. Implemented applications allow to take a closer look at currently running tests, in a similar way to JUnit view. To achieve visibility, information window is displayed always on top and doesn't require focus. That is useful to locate error both when creating a new test or analysing already implemented one.
}
